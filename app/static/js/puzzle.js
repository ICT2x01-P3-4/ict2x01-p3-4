...
function displayStepButton(){
    if (stage<=3){
        document.getElementById("puzzlebutton").innerHTML += "<button type='button' class='step flex m-3 pl-10 bg-yellow-400 bg-opacity-50 hover:bg-yellow-300 py-4 px-8 shadow-lg rounded-lg'>Step</button>";
    }
}
